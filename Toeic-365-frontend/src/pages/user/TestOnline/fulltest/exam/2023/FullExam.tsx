...
import { TOKEN_KEY, getCookie, getLocalStorage } from '../../../../../../hepers/Authentication';
    ...
    const handleSubmit = (e: any) => {
        ...
        if (!isSubmit) {
            ...
            swal({
                ...
                const result = axios.post('http://localhost:8081/api/history-exam/create-history-exam', dataPost, {
                    headers: {
                        Accept: 'application/json, text/plain',
                        'Content-Type': 'application/json',
                        Authorization: `Bearer ${accessToken}`,
                        // Config CORS network error
